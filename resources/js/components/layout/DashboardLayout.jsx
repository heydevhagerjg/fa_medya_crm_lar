...
import CallManager from "../chat/CallManager.jsx";
import {
    LayoutDashboard,
    Users,
    Briefcase,
...
export default function DashboardLayout({ children, isRestoring = false }) {
    ...
    // Chat notification listeners are handled by CallManager to avoid
    // duplicate Echo channel subscriptions on user.chats.{userId}
    ...
    return (
        <div className="theme-app-shell flex h-screen overflow-hidden">
            ...
            {/* Global Call Manager — handles Agora, incoming calls, floating widget */}
            {!isRestoring && <CallManager />}
        </div>
    );
}
